...
const ProjectRichTooltip: FC<Props> = ({ projectName }) => {
  ...
  if (featuresImages) isolatedFeatures.push("Images");
  if (featuresProfiles) isolatedFeatures.push("Profiles");
  if (featuresNetworks) isolatedFeatures.push("Networks");
  ...
  if (featuresStorageVolumes) isolatedFeatures.push("Storage volumes");
