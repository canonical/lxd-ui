...
import type { TLSIdentityFormValues } from "../forms/IdpGroupForm";
...
interface Props {
  ...
  setIdentityName: React.Dispatch<React.SetStateAction<string>>;
}

const CreateTLSIdentityPanel: FC<Props> = ({
  openPortal,
  onSuccess,
  setIdentityName,
}) => {
