...
const PermissionIdpGroups: FC = () => {
  ...
  const content = hasGroups ? (
    <>
      <Notification severity="information" title="IDP group mappings">
        <>
          Identity provider groups map authentication entities from your
          identity provider to groups within LXD.{" "}
          {!hasCustomClaim ? (
            <>
              <span>You need to set your server</span>{" "}
              <Link to="/ui/settings">
  ...
  return (
    <>
      ...
      >
        ...
        <Row className="permission-idp-groups">{content}</Row>
      </CustomLayout>
