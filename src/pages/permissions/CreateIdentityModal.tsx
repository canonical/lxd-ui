  ...
  return (
    <Modal
      ...
      buttonRow={
        <>
          {token && (
            <>
              <CopyTextBtn label="Copy identity token" text={token} />
              <Button
                aria-label="Close"
    ...
    >
      {token && (
        <>
          <p>
            The identity token below can be used to log in with the newly
            created identity{" "}
            <ResourceLabel type="certificate" value={identityName} /> .{" "}
            <b>
              Once this modal is closed, the identity token can&rsquo;t be
              generated again.
            </b>
          </p>
