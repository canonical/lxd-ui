...
const EditPlacementGroupPanel: FC = () => {
  ...
  const usedByProfiles = filterUsedByType("profile", placementGroup?.used_by);
    ...
    <>
      <SidePanel>
        ...
        <SidePanel.Content className="u-no-padding">
          ...
          <div>
            Used by instances
            {usedByInstances.length > 0 && <> ({usedByInstances.length})</>}
          </div>
          <div className="u-sv3">
          ...
          <div>
            Used by profiles
            {usedByProfiles.length > 0 && <> ({usedByProfiles.length})</>}
          </div>
          <div className="u-sv3">
