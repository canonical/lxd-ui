...
export const updateGroupsForIdentity = (
...
export const updateGroupsForIdentities = (
  identities: Partial<LxdIdentity>[],
  groupsForIdentities: Record<string, string[]>,
): Promise<void> => {
  return new Promise((resolve, reject) => {
    void Promise.allSettled(
      identities.map((identity) =>
        updateGroupsForIdentity(
          identity,
  ...
  return new Promise((resolve, reject) => {
    ...
    const removeIdentityPromises =
      identitiesRemoved?.map(async (identity) => {
        ...
        return updateGroupsForIdentity(
    ...
    const addIdentityPromises = identitiesAdded.map((identity) =>
      updateGroupsForIdentity(identity, [
        ...(identity.groups || []),
        group.name,
      ]),
    );
...
export const fetchLxdGroups = (): Promise<LxdGroup[]> => {
  return new Promise((resolve, reject) => {
...
export const fetchLxdGroup = (name: string): Promise<LxdGroup> => {
  return new Promise((resolve, reject) => {
...
export const createLxdGroup = (group: Partial<LxdGroup>): Promise<void> => {
  return new Promise((resolve, reject) => {
...
export const deleteLxdGroup = (group: string): Promise<void> => {
  return new Promise((resolve, reject) => {
...
export const updateLxdGroup = (group: Partial<LxdGroup>): Promise<void> => {
  return new Promise((resolve, reject) => {
