...
import { Icon, Label, Tooltip } from "@canonical/react-components";
...
const getUrl = ({
  ...
  return `/ui/project/${encodeURIComponent(project || "default")}/${entityType}/${encodeURIComponent(name)}`;
};
