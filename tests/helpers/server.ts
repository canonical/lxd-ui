...
export const addUserDefinedSetting = async (
  page: Page,
  key: string,
  value: string,
) => {
...
export const deleteUserDefinedSetting = async (page: Page, value: string) => {
  ...
  await button.click();
  await page
    .getByRole("button", { name: "Delete user setting", exact: true })
    .click();
